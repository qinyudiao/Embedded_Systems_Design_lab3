...
void outputTimer(int time, uint8_t cursor_num){
   
   int minute = (time / 60) % 60;
   int second = (time % 60);
   
   ST7735_SetCursor(8, cursor_num);
